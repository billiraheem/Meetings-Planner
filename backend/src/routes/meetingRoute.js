...
var routes = {
    'GET /api/meetings': function (req, res, _, body) { return (0, auth_1.authenticateUser)(req, res, function () { return (0, meetingController_1.handleGetMeetings)(req, res, new url_1.URL(req.url, "http://".concat(req.headers.host)).searchParams); }); },
    'POST /api/meetings': function (req, res, _, body) { return (0, auth_1.authenticateUser)(req, res, function () { return (0, meetingController_1.handleCreateMeeting)(req, res, body); }); },
    'GET /api/meetings/:id': function (req, res, params) { return (0, auth_1.authenticateUser)(req, res, function () { return (0, meetingController_1.handleGetMeeting)(req, res, params.id); }); },
    'PUT /api/meetings/:id': function (req, res, params, body) { return (0, auth_1.authenticateUser)(req, res, function () { return (0, meetingController_1.handleUpdateMeeting)(req, res, params.id, body); }); },
    'DELETE /api/meetings/:id': function (req, res, params) { return (0, auth_1.authenticateUser)(req, res, function () { return (0, meetingController_1.handleDeleteMeeting)(req, res, params.id); }); },
