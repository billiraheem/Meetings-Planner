...
var getMeeting = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, meeting_1.default.findById(id)];
...
var deleteMeeting = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, meeting_1.default.findByIdAndDelete(id)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
